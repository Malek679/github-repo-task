package michal.malek.model.message;
...
public class ErrorMessages {
    ...
    public static final String FETCH_BRANCHES_ERROR = "Failed to fetch branches for repository: %s";
    public static final String GENERAL_FETCH_ERROR = "Error fetching repository branches. Please try again.";
}
